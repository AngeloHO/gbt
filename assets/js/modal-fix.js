// // Scr// Script para fechar o modal Bootstrap e limpar backdrop
...
//             if (modalInstance) {do para fechar o modal quando o cadastro for bem-sucedido
    ...
    mutations.forEach(function (mutation) {
      ...
      mutation.addedNodes.forEach(function (node) {
        ...
        if (
          ...
          console.log(
            "[Modal Fix] Toast de sucesso detectado via MutationObserver"
          );
